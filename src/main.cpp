...
int main(int argc, char* argv[]) {
	try {
		...
		Scene scene(WIDTH, HEIGHT, make_float3(-1.0f, 2.0f, 2.0f), make_float3(0.0f, 0.5f, 0.0f), make_float3(0.0f, 1.0f, 0.0f), 60.0f);
		//add stuff
		...
		scene.addLight(make_float3(-5.0f, 2.0f, -1.0f), make_float3(0.8f, 0.8f, 0.8f));
#else //sponza
		float3 Ks = make_float3(0.6f, 0.6f, 0.6f);
		float3 Ka = make_float3(0.6f, 0.0f, 0.0f);
		float3 Kd = make_float3(0.5f, 0.0f, 0.0f);
		...
		scene.context["objects"]->set(scene.loadOBJ("sponza/sponza.obj", red));
